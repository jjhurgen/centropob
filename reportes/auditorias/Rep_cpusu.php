...
$fecha = $_POST['fecha_cp'];
$id_usuario = $_POST['usuario_cp'];
...
$query_user = $con->prepare("SELECT Persona FROM r_accionescp WHERE id_usuario = ? AND DATE(fecha) = ? LIMIT 1");
...
$query_acciones = $con->prepare("SELECT id, id_usuario, accion, fecha FROM r_accionescp WHERE id_usuario = ? AND DATE(fecha) = ?");
