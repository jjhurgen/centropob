...
$fecha = $_POST['fecha_asignasector'];
$id_usuario = $_POST['usu_asigsec'];
...
$query_user = $con->prepare("SELECT Persona FROM r_accionesasignasector WHERE id_usuario = ? AND DATE(fecha) = ? LIMIT 1");
...
$query_acciones = $con->prepare("SELECT id, id_usuario, accion, fecha FROM r_accionesasignasector WHERE id_usuario = ? AND DATE(fecha) = ?");
