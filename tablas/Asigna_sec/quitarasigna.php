...
try {
    ...
    if ($stmt->execute()) {
        ...
        $accion = "Se quitó la asignación del Sector con ID: $idsector";

        $registro_query = $con->prepare("INSERT INTO r_accionesAsignasector (id_usuario, persona, accion, fecha) VALUES (?, ?, ?, NOW())");
